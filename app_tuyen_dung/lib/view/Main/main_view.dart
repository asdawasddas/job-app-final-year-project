...
import 'package:app_tuyen_dung/view/Jobs/jobs_view.dart';
...
class _MainViewState extends State<MainView> {
  ...
  void initState() {
    ...
    Provider.of<EnterpriseProvider>(context, listen: false).getInfo();
    Provider.of<AccountProvider>(context, listen: false).getStatistic();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        bottomNavigationBar: NavigationBarTheme(
          ...
          child: NavigationBar(
            ...
            destinations: const <Widget>[
              ...
              NavigationDestination(
                selectedIcon: Icon(Icons.find_in_page, color: Colors.blue,),
        ...
        body: <Widget>[const HomeView(), const JobsView(), const AccountView()][currentPageIndex]
      ),
    );
  }
}
